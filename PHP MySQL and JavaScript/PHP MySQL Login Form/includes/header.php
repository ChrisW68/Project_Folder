    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
        ...
        <div class="container-fluid" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-light" href="admin/customers.php" style="color: #f3f3f3">Bill <strong>Manager</strong></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
             ...
             <?php //Check to see if user is logged in and collect session info and echo
                ...
                <ul class="nav navbar-nav navbar-right">
                 <li class="navbar-text">Welcome, Chris Wiseman </li>
                  <li class="dropdown">
